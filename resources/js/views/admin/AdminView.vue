<template>
    <div class="navigation">
        <ul>
            ...
            <li v-if="role == 1" @click.prevent="show = 'users'" id="users">
                <span class="icon">
                    <svg
                        width="40"
                        height="40"
            ...
            <li v-if="role == 1" @click.prevent="show = 'review'" id="review">
                <span class="icon">
                    <svg
                        width="40"
                        height="40"
            ...
            <li v-if="role == 1" @click.prevent="show = 'orders'" id="orders">
                <span class="icon">
                    <svg
                        width="40"
                        height="40"
            ...
            <li v-if="role == 1" @click.prevent="show = 'promo'" id="promo">
                <span class="icon">
                    <svg
                        width="40"
                        height="40"
            ...
            <li v-if="role == 1" @click.prevent="show = 'type'" id="type">
                <span class="icon">
                    <svg
                        width="40"
                        height="40"
            ...
            <li v-if="role == 1" @click.prevent="logout">
                <span class="icon">
                    ...
                    >
                        <path
                            d="M14.9444 1.25C13.5768 1.24998 12.4745 1.24996 11.6075 1.36652C10.7074 1.48754 9.9495 1.74643 9.34759 2.34835C8.82266 2.87328 8.55742 3.51836 8.41818 4.27635C8.28289 5.01291 8.25701 5.9143 8.25099 6.99583C8.24868 7.41003 8.58259 7.74768 8.9968 7.74999C9.41101 7.7523 9.74866 7.41838 9.75097 7.00418C9.75705 5.91068 9.78545 5.1356 9.8935 4.54735C9.99762 3.98054 10.1648 3.65246 10.4082 3.40901C10.685 3.13225 11.0736 2.9518 11.8074 2.85315C12.5627 2.75159 13.5638 2.75 14.9992 2.75H15.9992C17.4347 2.75 18.4358 2.75159 19.1911 2.85315C19.9249 2.9518 20.3135 3.13225 20.5902 3.40901C20.867 3.68577 21.0474 4.07435 21.1461 4.80812C21.2476 5.56347 21.2492 6.56459 21.2492 8V16C21.2492 17.4354 21.2476 18.4365 21.1461 19.1919C21.0474 19.9257 20.867 20.3142 20.5902 20.591C20.3135 20.8678 19.9249 21.0482 19.1911 21.1469C18.4358 21.2484 17.4347 21.25 15.9992 21.25H14.9992C13.5638 21.25 12.5627 21.2484 11.8074 21.1469C11.0736 21.0482 10.685 20.8678 10.4082 20.591C10.1648 20.3475 9.99762 20.0195 9.8935 19.4527C9.78545 18.8644 9.75705 18.0893 9.75097 16.9958C9.74866 16.5816 9.41101 16.2477 8.9968 16.25C8.58259 16.2523 8.24868 16.59 8.25099 17.0042C8.25701 18.0857 8.28289 18.9871 8.41818 19.7236C8.55742 20.4816 8.82266 21.1267 9.34759 21.6517C9.9495 22.2536 10.7074 22.5125 11.6075 22.6335C12.4745 22.75 13.5768 22.75 14.9444 22.75H16.0541C17.4217 22.75 18.524 22.75 19.391 22.6335C20.2911 22.5125 21.049 22.2536 21.6509 21.6517C22.2528 21.0497 22.5117 20.2919 22.6327 19.3918C22.7493 18.5248 22.7493 17.4225 22.7492 16.0549V7.94513C22.7493 6.57754 22.7493 5.47522 22.6327 4.60825C22.5117 3.70814 22.2528 2.95027 21.6509 2.34835C21.049 1.74643 20.2911 1.48754 19.391 1.36652C18.524 1.24996 17.4217 1.24998 16.0541 1.25H14.9444Z"
                            fill="#ffffff"
                        />
                        <path
                            d="M2 11.249C1.58579 11.249 1.25 11.5848 1.25 11.999C1.25 12.4132 1.58579 12.749 2 12.749L13.9726 12.749L12.0119 14.4296C11.6974 14.6991 11.661 15.1726 11.9306 15.4871C12.2001 15.8016 12.6736 15.838 12.9881 15.5685L16.4881 12.5685C16.6543 12.426 16.75 12.218 16.75 11.999C16.75 11.7801 16.6543 11.5721 16.4881 11.4296L12.9881 8.42958C12.6736 8.16002 12.2001 8.19644 11.9306 8.51093C11.661 8.82543 11.6974 9.2989 12.0119 9.56847L13.9726 11.249L2 11.249Z"
                            fill="#ffffff"
                        />
                    </svg>
                </span>
...
.navigation ul li:not(:first-child).active {
    background: #212529;
}
.navigation ul li:not(:first-child).active::before {
    content: "";
    position: absolute;
    top: -20px;
    right: 0;
...
.navigation ul li:not(:first-child).active::after {
    content: "";
    position: absolute;
    bottom: -20px;
    right: 0;
