    ...
    <div style="width: 90%; margin-left: 5%; display: flex; justify-content: center; margin-top: 5vw; flex-direction: column;">
        <div>
            ...
            <h1>Добавить промокод на 15% скидку</h1>
                <input type="text" v-model="promocode" placeholder="Придумайте промокод">
        ...
        <div class="container">
            ...
            <ul class="responsive-table">
                ...
                <li class="table-row" v-for="promo in promos" :key="promo">
                    ...
                    <div class="col col-3" @click="deletePromo(promo.id)" data-label="Действие">Delete</div>
                </li>               
            </ul>
        </div>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            deletePromo(id){
                axios.delete(`/api/delete_promo/${id}`)
                .then(res => {
                    this.getAllPromo()
                })
            },
            addPromo(){
                axios.post('/api/add_promo', {
